...
namespace Ay_Çiçeği_Pansiyon_Uygulaması_V._1
{
    public partial class FrmGelirGider : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int personel = Convert.ToInt16(txtPersonelMaas.Text);
              lblPersonelMaas.Text = (personel * 1500).ToString();

            int sonuc;

            sonuc = Convert.ToInt32(lblKasaToplam.Text) - Convert.ToInt32(lblPersonelMaas.Text) + Convert.ToInt32(lblGidalar.Text) + Convert.ToInt32(lblicecekler.Text) + Convert.ToInt32(lblAtistirmaliklar.Text)+Convert.ToInt32(lblElektrik.Text)+Convert.ToInt32(lblSu.Text)+Convert.ToInt32(lblinternet.Text);
        ...
        private void FrmGelirGider_Load(object sender, EventArgs e)
        {
            ...
            while (oku2.Read())
            {
                ...
                lblGidalar.Text = oku2["toplam1"].ToString();
            ...
            while (oku3.Read())
            {
                ...
                lblicecekler.Text = oku3["toplam2"].ToString();
            ...
            while (oku4.Read())
            {
                ...
                lblAtistirmaliklar.Text = oku4["toplam3"].ToString();
            ...
            while (oku5.Read())
            {
                ...
                lblElektrik.Text = oku5["toplam5"].ToString();
